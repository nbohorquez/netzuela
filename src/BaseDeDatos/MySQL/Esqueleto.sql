...
CREATE  TABLE IF NOT EXISTS `Spuria`.`Estado` (
  ...
  INDEX `fk_Estado_HusoHorarioNormal` (`HusoHorarioNormal` ASC) ,
  INDEX `fk_Estado_HusoHorarioVerano` (`HusoHorarioVerano` ASC) ,
  UNIQUE INDEX `RegionGeografica_P_UNIQUE` (`RegionGeografica_P` ASC) ,
  ...
  CONSTRAINT `fk_Estado_HusoHorarioNormal`
    ...
    REFERENCES `Spuria`.`HusoHorario` (`Valor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE  TABLE IF NOT EXISTS `Spuria`.`Tienda` (
  ...
  UNIQUE INDEX `CalificableSeguible_P_UNIQUE` (`CalificableSeguible_P` ASC) ,
...
-- -----------------------------------------------------
-- Table `Spuria`.`TipoDeCodigo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `Spuria`.`TipoDeCodigo` (
...
CREATE  TABLE IF NOT EXISTS `Spuria`.`Producto` (
  ...
  UNIQUE INDEX `Buscable_P_UNIQUE` (`Buscable_P` ASC) ,
  UNIQUE INDEX `CalificableSeguible_P_UNIQUE` (`CalificableSeguible_P` ASC) ,
  INDEX `fk_Producto_TipoDeCodigo` (`TipoDeCodigo` ASC) ,
  ...
  CONSTRAINT `fk_Producto_TipoDeCodigo`
    FOREIGN KEY (`TipoDeCodigo` )
    REFERENCES `Spuria`.`TipoDeCodigo` (`Valor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `Spuria`.`Consumidor` (
  ...
  CONSTRAINT `fk_Consumidor_GradoDeInstruccion`
    ...
    REFERENCES `Spuria`.`GradoDeInstruccion` (`Valor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Consumidor_GrupoDeEdad`
    FOREIGN KEY (`GrupoDeEdad` )
    REFERENCES `Spuria`.`GrupoDeEdad` (`Valor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE  TABLE IF NOT EXISTS `Spuria`.`Seguidor` (
  ...
  INDEX `fk_Seguidor_CalificableSeguible` (`CalificableSeguibleID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `Spuria`.`Registro` (
  ...
  CONSTRAINT `fk_Registro_CodigoDeError`
    ...
    REFERENCES `Spuria`.`CodigoDeError` (`Valor` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TRIGGER DespuesDeInsertarTienda AFTER INSERT ON Tienda
FOR EACH ROW
BEGIN
...
CREATE TRIGGER AntesDeEliminarTienda BEFORE DELETE ON Tienda
FOR EACH ROW
BEGIN
...
CREATE TRIGGER AntesDeActualizarTienda BEFORE UPDATE ON Tienda
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DespuesDeActualizarTienda AFTER UPDATE ON Tienda
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE Rastreable_P, bobo INT;
...
BEGIN
    ...
    END IF;
    IF NEW.TipoDeCodigo != OLD.TipoDeCodigo THEN
...
CREATE TRIGGER DespuesDeInsertarCliente AFTER INSERT ON Cliente
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeActualizarCliente BEFORE UPDATE ON Cliente
FOR EACH ROW
BEGIN
    IF NEW.Rastreable_P != OLD.Rastreable_P THEN
        SET NEW.Rastreable_P = OLD.Rastreable_P;
...
CREATE TRIGGER AnteDeEliminarCliente BEFORE DELETE ON Cliente
FOR EACH ROW
BEGIN
    DECLARE bobo INT;
...
CREATE TRIGGER DespuesDeActualizarCliente AFTER UPDATE ON Cliente
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER DespuesDeInsertarConsumidor AFTER INSERT ON Consumidor
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeActualizarConsumidor BEFORE UPDATE ON Consumidor
FOR EACH ROW
BEGIN
    IF NEW.Rastreable_P != OLD.Rastreable_P THEN
        SET NEW.Rastreable_P = OLD.Rastreable_P;
...
CREATE TRIGGER DespuesDeActualizarConsumidor AFTER UPDATE ON Consumidor
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeEliminarConsumidor BEFORE DELETE ON Consumidor
FOR EACH ROW
BEGIN
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeActualizarUsuario BEFORE UPDATE ON Usuario
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DespuesDeActualizarUsuario AFTER UPDATE ON Usuario
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
...
CREATE TRIGGER AntesDeEliminarUsuario BEFORE DELETE ON Usuario
FOR EACH ROW
BEGIN
    DELETE FROM Acceso WHERE AccesoID = OLD.UsuarioID;
    DELETE FROM Busqueda WHERE BusquedaID = OLD.UsuarioID;
END $$
...
CREATE TRIGGER DespuesDeInsertar AFTER INSERT ON Busqueda
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeActualizarBusqueda BEFORE UPDATE ON Busqueda
FOR EACH ROW
BEGIN
    IF NEW.Rastreable_P != OLD.Rastreable_P THEN
        SET NEW.Rastreable_P = OLD.Rastreable_P;
...
CREATE TRIGGER AntesDeEliminarBusqueda BEFORE DELETE ON Busqueda
FOR EACH ROW
BEGIN
    DECLARE bobo INT;
    
    SELECT RegistrarEliminacion(OLD.Rastreable_P, CONCAT('Busqueda: ', CAST(OLD.BusquedaID AS CHAR))) INTO bobo;
...
CREATE TRIGGER AntesDeActualizarRegistro BEFORE UPDATE ON Registro
FOR EACH ROW
BEGIN
...
CREATE TRIGGER AntesDeActualizarBuscable BEFORE UPDATE ON Buscable
FOR EACH ROW
BEGIN
...
CREATE TRIGGER AntesDeEliminarBuscable BEFORE DELETE ON Buscable
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DespuesDeInsertarEstadisticasDeVisitas AFTER INSERT ON EstadisticasDeVisitas
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE Rastreable_P, bobo INT;
...
CREATE TRIGGER AntesDeActualizarEstadisticasDeVisitas BEFORE UPDATE ON EstadisticasDeVisitas
FOR EACH ROW
BEGIN
    IF NEW.Estadisticas_P != OLD.Estadisticas_P THEN
        SET NEW.Estadisticas_P = OLD.Estadisticas_P;
...
CREATE TRIGGER AntesDeEliminarEstadisticasDeVisitas BEFORE DELETE ON EstadisticasDeVisitas
FOR EACH ROW
BEGIN
...
CREATE TRIGGER DespuesDeInsertarEstadisticas AFTER INSERT ON Estadisticas
FOR EACH ROW
BEGIN
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeActualizarEstadisticas BEFORE UPDATE ON Estadisticas
FOR EACH ROW
BEGIN
    IF NEW.Rastreable_P != OLD.Rastreable_P THEN
        SET NEW.Rastreable_P = OLD.Rastreable_P;
...
CREATE TRIGGER AntesDeEliminarEstadisticas BEFORE DELETE ON Estadisticas
FOR EACH ROW
BEGIN
    DECLARE bobo INT;
    
    SELECT RegistrarEliminacion(OLD.Rastreable_P, CONCAT('Estadisticas: ', CAST(OLD.EstadisticasID AS CHAR))) INTO bobo;
...
CREATE TRIGGER DespuesDeInsertarPatrocinante AFTER INSERT ON Patrocinante
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE Rastreable_P, bobo INT;
...
CREATE TRIGGER AntesDeModificarPatrocinante BEFORE UPDATE ON Patrocinante
FOR EACH ROW
BEGIN
    IF NEW.Cliente_P != OLD.Cliente_P THEN
        SET NEW.Cliente_P = OLD.Cliente_P;
...
CREATE TRIGGER AntesDeEliminarPatrocinante BEFORE DELETE ON Patrocinante
FOR EACH ROW
BEGIN
...
BEGIN
    ...
    SELECT RegistrarEliminacion(OLD.Rastreable_P, CONCAT('Croquis: ', CAST(OLD.CroquisID AS CHAR))) INTO bobo;
...
CREATE TRIGGER DespuesDeInsertarAdministrador AFTER INSERT ON Administrador
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeActualizarAdministrador BEFORE UPDATE ON Administrador
FOR EACH ROW
BEGIN
    IF NEW.Rastreable_P != OLD.Rastreable_P THEN
        SET NEW.Rastreable_P = OLD.Rastreable_P;
...
CREATE TRIGGER DespuesDeActualizarAdministrador AFTER UPDATE ON Administrador
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE bobo INT;
...
CREATE TRIGGER AntesDeEliminarAdministrador BEFORE DELETE ON Administrador
FOR EACH ROW
BEGIN
    DECLARE bobo INT;
...
CREATE TRIGGER DespuesDeInsertarResultadoDeBusqueda AFTER INSERT ON ResultadoDeBusqueda
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE Rastreable_P, bobo INT;
...
CREATE TRIGGER AntesDeActualizarResultadoDeBusqueda BEFORE UPDATE ON ResultadoDeBusqueda
FOR EACH ROW
BEGIN
    IF NEW.BusquedaID != OLD.BusquedaID THEN
        SET NEW.BusquedaID = OLD.BusquedaID;
...
CREATE TRIGGER DespuesDeActualizarResultadoDeBusqueda AFTER UPDATE ON ResultadoDeBusqueda
FOR EACH ROW
BEGIN
    DECLARE Parametros TEXT;
    DECLARE Rastreable_P, bobo INT;
