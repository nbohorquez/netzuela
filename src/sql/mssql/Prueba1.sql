...
*******************************************************
*/
DECLARE @TiendaRastreable int, @bobo int

SET @TiendaRastreable =
(
	SELECT Rastreable_P 
	FROM Tienda, Cliente
...
EXEC dbo.InsertarInventario$IMPL 
	@a_Creador = @TiendaRastreable, 
	@a_TiendaID = @TiendaID1, 
	@a_Codigo = 'TD-015SC', 
	@a_Descripcion = 'Computadora SGI 02', 
	@a_Visibilidad = 'Ambos visibles', 
	@a_ProductoID = @ProductoID1, 
	@a_Precio = 640.00, 
	@a_Cantidad = 12, 
...
EXEC dbo.InsertarInventario$IMPL 
	...
	@a_TiendaID = @TiendaID1, 
	@a_Codigo = 'TD-1841C', 
	@a_Descripcion = 'Celular N78 Ve', 
	@a_Visibilidad = 'Ambos visibles', 
	@a_ProductoID = @ProductoID2, 
	@a_Precio = 104.00, 
	@a_Cantidad = 9, 
	@returnvalue = @bobo OUTPUT;
...
EXEC dbo.InsertarInventario$IMPL 
	...
	@a_TiendaID = @TiendaID1, 
	@a_Codigo = 'TD-99410', 
	@a_Descripcion = 'Control de N64 Gris', 
	@a_Visibilidad = 'Ambos visibles', 
	@a_ProductoID = @ProductoID3, 
	@a_Precio = 8400.00, 
	@a_Cantidad = 2, 
	@returnvalue = @bobo OUTPUT;
...
EXEC dbo.InsertarInventario$IMPL 
	@a_Creador = @TiendaRastreable, 
	@a_TiendaID = @TiendaID2, 
	@a_Codigo = 'PSDC-41C', 
	@a_Descripcion =  'Microfono en vivo SM57 XLR', 
	@a_Visibilidad = 'Ambos visibles', 
	@a_ProductoID = @ProductoID4, 
	@a_Precio = 1500.00, 
	@a_Cantidad = 4, 
	@returnvalue = @bobo OUTPUT;
